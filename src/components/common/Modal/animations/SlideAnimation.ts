...
export default class SlideAnimation extends Animation {
  ...
  static SLIDE_FROM_TOP = "top" as const;
  static SLIDE_FROM_BOTTOM = "bottom" as const;
  static SLIDE_FROM_LEFT = "left" as const;
  static SLIDE_FROM_RIGHT = "right" as const;
  ...
  getAnimations(): any {
    const transform: any[] = []; // eslint-disable-line @typescript-eslint/no-explicit-any
