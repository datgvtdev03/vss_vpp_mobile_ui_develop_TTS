...
import { ModalProps, DragEvent } from "../type";
...
class BaseModal extends Component<ModalProps, State> {
  ...
  isSwipingOut = false;
  lastSwipeEvent: DragEvent | null = null;
  ...
  get pointerEvents(): "box-none" | "none" | "box-only" | "auto" | undefined {
  ...
  handleMove = (event: DragEvent): void => {
    ...
    let newOpacity;
    const opacity = this.props.overlayOpacity || 0.5;
    ...
    this.backdrop && this.backdrop.setOpacity(newOpacity);
  };
